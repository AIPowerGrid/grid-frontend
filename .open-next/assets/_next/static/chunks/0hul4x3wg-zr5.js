    ...
    let p = (e) => {
      ...
      K = (function (e, ...r) {
              ...
              (s = (l = {
                ...
                ...((e) => {
                  let r = ((e) => {
                      ...
                      return (
                        a(Object.entries(e.classGroups), o).forEach(
                          ([e, o]) => {
                            n(o, t, e, r);
                          }
                        ),
        ...
        let e = u('colors'),
          ...
          f = u('gradientColorStopPositions'),
          g = u('inset'),
          h = u('margin'),
          x = u('opacity'),
          y = u('padding'),
        ...
        return {
          ...
          classGroups: {
            ...
            grow: [{ grow: Q() }],
            shrink: [{ shrink: Q() }],
            order: [{ order: ['first', 'last', 'none', C, S] }],
            'grid-cols': [{ 'grid-cols': [R] }],
            'col-start-end': [{ col: ['auto', { span: ['full', C, S] }, S] }],
            'col-start': [{ 'col-start': D() }],
            'col-end': [{ 'col-end': D() }],
            'grid-rows': [{ 'grid-rows': [R] }],
            'row-start-end': [{ row: ['auto', { span: [C, S] }, S] }],
            ...
            w: [
              { w: ['auto', 'min', 'max', 'fit', 'svw', 'lvw', 'dvw', S, r] }
            ],
            'min-w': [{ 'min-w': [S, r, 'min', 'max', 'fit'] }],
            'max-w': [
              {
                'max-w': [
                  S,
            ...
            h: [
              { h: [S, r, 'auto', 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }
            ],
            'min-h': [
              { 'min-h': [S, r, 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }
            ],
            'max-h': [
              { 'max-h': [S, r, 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }
            ],
            size: [{ size: [S, r, 'auto', 'min', 'max', 'fit'] }],
            'font-size': [{ text: ['base', G, k] }],
            ...
            'underline-offset': [{ 'underline-offset': ['auto', w, S] }],
            ...
            'outline-offset': [{ 'outline-offset': [w, S] }],
            ...
            contrast: [{ contrast: [i] }],
            'drop-shadow': [{ 'drop-shadow': ['', 'none', G, S] }],
